      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden p-0">
        <div className="flex h-[80vh]">
          ...
          <div className="w-72 bg-gray-50 border-r flex flex-col">
            ...
            <Tabs defaultValue="usage" orientation="vertical" className="flex-1 flex flex-col">
              <TabsList className="grid w-full grid-rows-4 h-auto bg-transparent p-4 gap-2">
                <TabsTrigger 
                  value="general" 
                  className="justify-start w-full data-[state=active]:bg-white data-[state=active]:shadow-sm h-12"
                >
          ...
          <div className="flex-1 overflow-y-auto">
            <Tabs defaultValue="usage" orientation="vertical" className="h-full">
